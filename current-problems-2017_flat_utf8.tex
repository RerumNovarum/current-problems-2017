...
Наряду с \( L(\mathbb{K}^n) \)
    ...
    \( \|A\|_{\mathrm{op}} = \sup_{\|x\|=1,\ \mathbb{K}^n} \|A x\|,\ \)
...
\smallskip
\textbf{Теорема 1.}
\emph{О подобии (в~общей постановке см.~\texttt{[1, 2]}).}
{\it
...
{\it
    ...
    \[
        ...
        \]
    \[
        \lambda_{m+1} \stackrel{\mathrm{def}}{=} 0,
        \]
    является допустимой.
    При этом
    \[
